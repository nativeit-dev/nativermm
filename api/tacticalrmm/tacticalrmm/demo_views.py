...
SVC_FILE = settings.BASE_DIR.joinpath("nativermm/test_data/winsvcs.json")
PROCS_FILE = settings.BASE_DIR.joinpath("nativermm/test_data/procs.json")
EVT_LOG_FILE = settings.BASE_DIR.joinpath("nativermm/test_data/appeventlog.json")
